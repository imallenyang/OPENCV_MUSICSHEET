...
staff_files = ["resources/template/staff3.png", "resources/template/staff2.png", "resources/template/staff.png"]
quarter_files = ["resources/template/quarter.png", "resources/template/solid-note.png"]
...
for rec in quarter_recs:
    print(rec)
# print("Merging quarter image results...")
# recs = [j for i in quarter_recs for j in i]
# quarter_recs = merge_recs(recs, 0.5)
